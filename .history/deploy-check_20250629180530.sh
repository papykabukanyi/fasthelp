...
echo "================================================================"
echo "1. ⚠️  DEBUGGING MODE ACTIVE - Server will run quick-debug.js"
echo "2. Check Railway deploy logs for DETAILED error messages"
echo "3. Look for specific error patterns in the debug output"
echo "4. Verify JWT_SECRET is set (required for main server to start)"
echo "5. After debugging, we'll switch back to the main server"
echo "6. Test debug endpoint: /debug-test (should return 'DEBUG TEST OK')"
echo ""
