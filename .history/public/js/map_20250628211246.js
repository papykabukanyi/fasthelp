...
class FastHelpMap {
    ...
    createPopupContent(donation) {
        const timeAgo = this.getTimeAgo(new Date(donation.created_at));
        const categoryIcon = this.getCategoryIcon(donation.category);
        
        return `
            <div class="donation-popup-content">
                ${donation.image_path ? `<img src="${donation.image_path}" alt="${donation.title}" class="popup-image">` : ''}
                ...
                <div class="popup-meta">
                    <div class="popup-donor">
                        ...
                        By ${donation.full_name || donation.username}
                    </div>
                ...
                <div class="popup-actions">
                    <button onclick="getDirections(${donation.latitude}, ${donation.longitude})" class="popup-btn primary">
                        <i class="fas fa-directions"></i>
                        Get Directions
                    </button>
                    <button onclick="reportClaimed('${donation.uuid}')" class="popup-btn secondary">
