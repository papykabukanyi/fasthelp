...
// Dark mode functionality with better error handling
class ThemeManager {
    constructor() {
    ...
    getStoredTheme() {
        try {
            return localStorage.getItem('fasthelp-theme');
        } catch (error) {
    ...
    setStoredTheme(theme) {
        try {
            localStorage.setItem('fasthelp-theme', theme);
        } catch (error) {
    ...
    applyTheme(theme) {
        ...
        // Also set on root for CSS variables
